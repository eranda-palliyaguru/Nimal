    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
		...
		<li>
		  ...
		  <li>
          <a rel="facebox" href="lord_sales.php">
          ...
          <a  href="sales.php?id=qt<?php echo date("ymdhis");?>">
		   ...
		   <li>
          <a  href="sales.php?id=pu<?php echo date("ymdhis");?>">
            <i class="fa fa-file-text-o"></i> <span>purchase</span>
            <span class="pull-right-container">
          ...
          <ul class="treeview-menu">
            <li><a href="sales_rp.php?d1=<?php echo date("Y-m-d");?>&d2=<?php echo date("Y-m-d");?>"><i class="fa fa-circle-o text-yellow"></i> Sales Report</a></li>
			  <li><a href="sms_rp.php?d1=<?php echo date("Y-m-d");?>&d2=<?php echo date("Y-m-d");?>"><i class="fa fa-circle-o text-yellow"></i> SMS Report</a></li>
            <li><a href="month_end.php"><i class="fa fa-circle-o text-yellow"></i> Month End Report</a></li>
          </ul>
        </li>
          </ul>
        </li> 
